...
Onde cada $c_i, a_j, b_k$ são irredutíveis, nenhum $a_j$ é associado a nenhum $b_k$, e consideramos que o produto vazio é $1$.
Como $a\not |b$ e $b\not | a$, temos que $J, K\neq\emptyset$.
...
Como $d_1\dots d_k|\prod_{i \in I} c_i \prod_{j \in J} a_j$, pela unicidade de fatoração, todo $d_l$ é associado a algum $c_i$ ou $d_k$, de forma injetora.
Como $d\not |c$, algum $d_l$ é associado a algum $a_j$.
Porém, $d_1\dots d_k|\prod_{i \in I} c_i \prod_{k \in K} c_k$, e, portanto, esse mesmo $d_l$ é associado a algum $c_k$.
