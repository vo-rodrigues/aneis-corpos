...
Se $x, y, z \in X$, precisamos dar sentido à expressões como $x^2y^3z^4$ e $xy^2+xz^3$. A definição abaixo cuida disso.
...
\begin{corol}
Se $R$ é um anel comutativo, $a \in R$ e $p(x)\in R[x]$, então existe único $q(x)\in R[x]$ tal que $p(x)=q(x)(x-a)+p(a)$.
\end{corol}
\begin{proof}
