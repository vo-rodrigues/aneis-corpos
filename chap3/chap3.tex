...
\begin{exer}
    Mostre que a interseção de qualquer coleção não vazia de subanéis de um dado anel é um subanel. Exiba um exemplo de dois subanéis de algum anel cuja união não seja um subanel.
\end{exer}
