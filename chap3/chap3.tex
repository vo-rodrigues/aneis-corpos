...
\begin{exer}
    Seja $A$ um anel e $\mathcal S$ uma coleção não vazia de subanéis de $A$ tais que para todos $B, C \in A$ existe $D \in \mathcal S$ tal que $B\cap C\subseteq D$. Mostre que $\bigcup_{B \in \mathcal S} B$ é um subanel de $A$.
\end{exer}