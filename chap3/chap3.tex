...
\begin{exer}
    Seja $A$ um anel e $\mathcal S$ uma coleção não vazia de subanéis de $A$ tais que para todos $B, C \in \mathcal S$ existe $D \in \mathcal S$ tal que $B\cup C\subseteq D$. Mostre que $\bigcup_{B \in \mathcal S} B$ é um subanel de $A$.
\end{exer}

\begin{exer}
    Seja $A$ um anel e $\mathcal S$ uma coleção não vazia de subaneis de $A$ que são também corpos, e tais que para todos $B, C \in \mathcal S$ existe $D \in \mathcal S$ tal que $B\cup C\subseteq D$. Mostre que $\bigcup_{B \in \mathcal S} B$ é um corpo.
\end{exer}